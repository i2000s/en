...
[![Build Status](https://travis-ci.org/i2000s/en.svg?branch=dev)](https://travis-ci.org/i2000s/en)
<a href="https://validator.w3.org/feed/check.cgi?url=https%3A//i2000s.github.io/en/atom.xml"><img src="{{site.url}}{{site.baseurl}}/assets/img/valid-rss-rogers.png" alt="[Valid RSS]" title="Validate my RSS feed" /></a>
