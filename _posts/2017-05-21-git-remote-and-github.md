...
![Freshly-Made GitHub Repository]({{site.baseurl}}/assets/img/git-freshly-made-github-repo.svg)
...
Click on the 'HTTPS' link to change the [protocol](https://gist.github.com/grawity/4392747) from
SSH to HTTPS.
...
![GitHub Repository After First Push]({{site.baseurl}}/assets/img/github-repo-after-first-push.svg)
